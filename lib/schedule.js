...
function scheduleJob() {
  ...
  var timezone;// = (typeof (name ? arguments[2] : arguments[1]) === 'string') ? (name ? arguments[2] : arguments[1]) : undefined;
  var method;// = name ? arguments[3] : arguments[2];
  var callback;// = name ? arguments[4] : arguments[3];
