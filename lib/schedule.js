...
function Job(name, job, callback) {
  ...
  //setup a private date of last execution date
  ...
  this.lastExecution = function() {
    return lastExecution;
  };
  this.setLastExecution = function(date) {
    lastExecution = new CronDate(date);
  };
...
Job.prototype.invoke = function(fireDate) {
  if (typeof this.job == 'function') {
    ...
    this.setLastExecution(fireDate);
    this.job(fireDate);
  } else {
